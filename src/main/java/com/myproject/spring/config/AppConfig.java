...
@ComponentScans(value = {
		@ComponentScan("com.myproject.spring.dao"),
		@ComponentScan("com.myproject.spring.service")
})
...
//		Setting hibernate properties
		properties.put(SHOW_SQL, env.getProperty("mysql.show_sql"));
		properties.put(HBM2DDL_AUTO, env.getProperty("mysql.hbm2ddl.auto"));
...
//		Setting c3p0 properties
		...
		factoryBean.setPackagesToScan("com.myproject.spring.model");
